...
setwd("D:/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/DUST/12km")
...
TS <- TS[1:96]
 ...
 writeRaster(BBB, "DUST_mass_12km_WRFChem_DUST1_Em3.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
WRF_STACK_image <- stack("D:/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/DUST/12km/DUST_mass_12km_WRFChem_DUST1_Em3.tif")
output_folder <- "D:/Dust_Event_UAE_2015/WRF_trial_runs/images_png/mass_12km_Em3/"
...
MASS_images <- stack("D:/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/DUST/12km/DUST_mass_12km_WRFChem_DUST1_Em3.tif")

for (i in 1:length(MASS_images@layers)) {
  TITLE <- paste(TS[i], " (UTC)")
  name_time <- TS[i]
  MASS_images <- raster("D:/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/DUST/12km/DUST_mass_12km_WRFChem_DUST1_Em3.tif", band = i)
    # plot(AOD_images)
