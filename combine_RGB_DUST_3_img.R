...
start <- as.POSIXct("2015-04-01") # from 6:00am to 4:00pm
...
# magick -delay 100 -loop 0 *.jpg SEVIRI_RGB_and_DUST_mask_event_02_April_2015_III.gif
...
patt <- ".png"
filenames_DUST_I_method <- list.files(pattern = patt)
DUST_MASK_I_method <- image_read(filenames_DUST_I_method[i])
plot(DUST_MASK_I_method)


# setwd("D:/Dust_Event_UAE_2015/SEVIRI_20150402_outputs/II_method/images_png/20150401_selected_dust")
# setwd("D:/Dust_Event_UAE_2015/SEVIRI_20150402_outputs/II_method/images_png/20150402_selected_dust")
# setwd("D:/Dust_Event_UAE_2015/SEVIRI_20150402_outputs/II_method/images_png/20150403_selected_dust")
 setwd("D:/Dust_Event_UAE_2015/SEVIRI_20150402_outputs/I_method/images_png/20150404_selected_dust")

patt <- ".png"
filenames_DUST_II_method <- list.files(pattern = patt)
DUST_MASK_II_method <- image_read(filenames_DUST_II_method[i])
plot(DUST_MASK_II_method)


# stack images in one stack
img <- c(RGB, DUST_MASK_I_method, DUST_MASK_II_method)
img <- image_scale(img, "500x500")
image_info(img)

left_to_right <- image_append(image_scale(img, "x300"))
plot(left_to_right)


setwd("D:/Dust_Event_UAE_2015/SEVIRI_20150402_outputs/II_method/combined_DUST_Mask_and_RGB_III")


name <- str_sub(filenames_DUST_I_method[i], start = 1, end = -5)
...
# magick -delay 100 -loop 0 *.png SEVIRI_RGB_and_DUST_mask_event_02_April_2015_III.gif
