...
writeRaster(BBB, "Temperature_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "Wind_speed_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
writeRaster(BBB, "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/extinction55/4km/Wind_speed_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "Wind_direction_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
writeRaster(BBB, "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/extinction55/4km/Wind_direction_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "RH_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
writeRaster(BBB, "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/extinction55/4km/RH_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "pressure_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
writeRaster(BBB, "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/WRF_trial_runs/DUST_AOD_FK/extinction55/4km/pressure_4km_WRFChem_DUST300.tif" , options= "INTERLEAVE=BAND", overwrite=T)
