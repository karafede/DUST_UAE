...
WRF_STACK_image_temp <- stack("Z:/_SHARED_FOLDERS/Air Quality/WRFChem/20150402_dust_only/big_domain/Temp_2m_WRFChem_02April2015_stack_6_DAYS_LARGE.tif")
n <- length(WRF_STACK_image_temp@layers)-1
...
site_Temp <- NULL
 ...
 for (i in 1:n) {   # this is a time
  ...
  WRF_STACK_image_temp <- raster("Z:/_SHARED_FOLDERS/Air Quality/WRFChem/20150402_dust_only/big_domain/Temp_2m_WRFChem_02April2015_stack_6_DAYS_LARGE.tif", band = i)
...
# save data-------------------------------------
write.csv(extracted_WRF_Temp, "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/AWS_2015 WEATHER/dust_event_outputs/extracted_WRF_Temp.csv")
extracted_WRF_Temp <- read.csv("Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/AWS_2015 WEATHER/dust_event_outputs/extracted_WRF_Temp.csv")
...
write.csv(All_AWS_data, "Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/AWS_2015 WEATHER/dust_event_outputs/AWS_WRFChem_Temp_Data_2015.csv")
...
AWS_WRF_2015_Temp <- read.csv("AWS_WRFChem_Temp_Data_2015.csv")
...
jpeg('Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/AWS_2015 WEATHER/dust_event_outputs/NCMS_WRF_TEMPERATURE_TimeSeries.jpg',
...
jpeg('Z:/_SHARED_FOLDERS/Air Quality/Phase 2/Dust_Event_UAE_2015/AWS_2015 WEATHER/dust_event_outputs/NCMS_WRF_TEMPERATURE_TimeSeries_selected.jpg',
     quality = 100, bg = "white", res = 300, width = 18, height = 9, units = "in")
par(mar=c(4, 10, 9, 2) + 0.3)
oldpar <- par(las=1)
